   ...
   If($sourceVm)
      {
         ...
         $customize = New-AzResourceGroupDeployment -Name CustomizeImage  -ResourceGroupName $sourceVm.ResourceGroupName  -TemplateFile .\modules\image.bicep -Vmname $sourceVm.Name -Verbose
